...
router.put(
	...
	[
		...
		[
			...
			check('from', 'From daye is required').not().isEmpty()
		]
	],
	async (req, res) => {
		const errors = validationResult(req);
...
// @route   PUT api/profile/educatio
...
router.put(
	...
	[
		auth,
		[
			check('school', 'University/School is required').not().isEmpty(),
...
router.get('/github/:username', async (req, res) => {
	try {
		const options = {
			...
			method: 'GET',
			headers: { 'User-Agent': 'Ceylon_Developers' }
		};
